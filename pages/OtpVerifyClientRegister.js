...
<h3>SD CANTEEN</h3>
<h2>Otp Successfully send to <span>{email}</span></h2>
<li>
<h6 style={{top:"-48%"}}>Enter 6 Digit Otp send to Email Id <span>*</span></h6>
<input type="number" name="" placeholder="Enter OTP" maxLength={6} value={otp} onChange={(e)=>setOtp(e.target.value)}/>
<TbDeviceMobileMessage className={ClientStyle.icon} />
</li>
<button style={{marginLeft:"36%"}} onClick={VerifyUser}> Verify User</button>
