...
addItem({id,price,JuiceName,Qty,Size,Image,subId,Category,QtyBook,totalAmount})
...
<Rating initialValue="5" readonly="true" className={style.startIcon} allowFraction/>
...
return (<div className={style.radioCard} key={itemss._id}>
 <li><label><span><input type="radio" name="size" onClick={()=>setItems(itemss.sizeName,itemss.Price,itemss._id)} value={itemss.sizeName} defaultChecked={selected === itemss.sizeName}/>
{(itemss.sizeName=="largesize")?"Large": 
(itemss.sizeName=="smallsize")?"Small":
 (itemss.sizeName=="mediumsize")?"Medium":
  (itemss.sizeName=="halfsize")?"Half": 
  (itemss.sizeName=="normalsize")?"Normal"
 : ""}
 </span></label></li>
</div>
)
...
<div className={style.avgRate}></div>
<div className={style.totalStar}></div>
</div>
